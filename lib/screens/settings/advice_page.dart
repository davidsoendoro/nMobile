...
import 'package:nmobile/components/dialog/simple_confirm.dart';
                  ...
                  SizedBox(
                    ...
                    child: FlatButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Label(
                            _localizations.notification + '[debug]',
                            type: LabelType.bodyRegular,
                            color: DefaultTheme.fontColor1,
                            height: 1,
                          ),
                            ...
                            children: <Widget>[
                              CupertinoSwitch(
                                ...
                                onChanged: (value) async {
                                  _localStorage.set('${SettingsStorage.SETTINGS_KEY}:${SettingsStorage.DEBUG_KEY}', value);
