...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "create_nkn_wallet_title" : MessageLookupByLibrary.simpleMessage("创建主网账户"),
    ...
    "error_client_address_format" : MessageLookupByLibrary.simpleMessage("DChat ID 不正确"),
    "error_confirm_password" : MessageLookupByLibrary.simpleMessage("密码不匹配"),
    "error_email_address_format" : MessageLookupByLibrary.simpleMessage("邮箱地址无效"),
    "error_eth_address_format" : MessageLookupByLibrary.simpleMessage("ETH 账户地址无效"),
    "error_field_required" : m1,
    "error_keystore_format" : MessageLookupByLibrary.simpleMessage("Keystore 错误"),
    "error_nkn_address_format" : MessageLookupByLibrary.simpleMessage("NKN 账户地址无效"),
    ...
    "import_keystore_nkn_wallet_desc" : MessageLookupByLibrary.simpleMessage("从已有的账户中，找出如何导出keystore以及关联的密码，对二者进行备份，然后用其导入nMobile。"),
    ...
    "import_seed_nkn_wallet_desc" : MessageLookupByLibrary.simpleMessage("从已有的账户中，找出如何导出Seed（也称为“秘密种子”），对其进行备份，然后使用它导入nMobile。"),
    ...
    "menu_dataRide" : MessageLookupByLibrary.simpleMessage("数旅"),
    ...
    "no_wallet_desc" : MessageLookupByLibrary.simpleMessage("使用我们的智能账户管理器管理您的主网\nNKN通证。"),
    ...
    "restart_device_confirm_desc" : MessageLookupByLibrary.simpleMessage("重启过程需要等待几分钟，您确定要重启该设备吗？"),
    ...
    "select_wallet_type_desc" : MessageLookupByLibrary.simpleMessage("选择创建 NKN 主网账户还是用来保存 NKN ERC-20 通证的以太坊账户。两者是不兼容的。"),
    ...
    "something_went_wrong" : MessageLookupByLibrary.simpleMessage("出错了！请稍后重试。"),
    ...
    "wallet_password_error" : MessageLookupByLibrary.simpleMessage("密码建议使用大、小写和特殊字符的组合。"),
    "wallet_password_helper_text" : MessageLookupByLibrary.simpleMessage("密码建议使用大、小写和特殊字符的组合。"),
    "wallet_password_mach" : MessageLookupByLibrary.simpleMessage("密码建议使用大、小写和特殊字符的组合。"),
